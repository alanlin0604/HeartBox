            ...
            try:
                ...
                if provider:
                    ...
                    content = (
                        ...
                        f'--- Diary excerpts ---\n{diary_snippets}\n\n'
                        f'Write a 3-paragraph flowing summary (not a numbered list, '
                        f'not a hierarchical bullet list with "1. / a. / b." — those '
                        f'render badly in our UI). The three paragraphs should cover:\n'
                        f'  Paragraph 1: Emotional themes observed (e.g., "This week '
                        f'has felt mostly steady, with a noticeable dip around mid-week '
                        f'tied to work pressure").\n'
                        f'  Paragraph 2: Specific observations from diary content '
                        f'(no verbatim quotes; refer to themes like "the deadline '
                        f'pressure you mentioned").\n'
                        f'  Paragraph 3: 2-3 concrete personalized suggestions woven '
                        f'into prose ("Try setting aside 10 minutes after lunch for...").\n'
                        f'Be warm, conversational, and specific. Keep total length '
                        f'around 200-350 characters. Do NOT use numbered lists, '
                        f'sub-bullets, headers, bold, or markdown — just flowing prose.'
                    )
